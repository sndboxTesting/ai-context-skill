...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (67 intent classes) |
...
- `intent` — one of 67 registered intent classes
...
<!-- AUTO:COMMANDS -->
**126 registered commands.** Key groups:
...
**gmail**: `/gmail`  `/gmail-auth`  `/gmail-promos`  `/gmail-read`  `/gmail-social`  `/gmail-spam`  `/gmail-summarize`  `/gmail-summary`  `/gmail-thread`
**ha**: `/ha`
**help**: `/help`
**image**: `/image-save`
