...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (97 intent classes) |
...
- `intent` — one of 97 registered intent classes
...
<!-- AUTO:COMMANDS -->
**160 registered commands.** Key groups:
