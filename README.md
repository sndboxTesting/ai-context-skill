...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (106 intent classes) |
...
- `intent` — one of 106 registered intent classes
...
<!-- AUTO:COMMANDS -->
**169 registered commands.** Key groups:
