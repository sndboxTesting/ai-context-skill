...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (73 intent classes) |
...
- `intent` — one of 73 registered intent classes
...
<!-- AUTO:COMMANDS -->
**133 registered commands.** Key groups:
...
**gmail**: `/gmail`  `/gmail-archive`  `/gmail-auth`  `/gmail-cancel`  `/gmail-confirm`  `/gmail-mark-read`  `/gmail-mark-unread`  `/gmail-promos`  `/gmail-read`  `/gmail-social`  `/gmail-spam`  `/gmail-summarize`  `/gmail-summary`  `/gmail-thread`  `/gmail-trash`
**ha**: `/ha`
**help**: `/help`
**image**: `/image-save`
