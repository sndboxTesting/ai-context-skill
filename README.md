...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (94 intent classes) |
...
- `intent` — one of 94 registered intent classes
...
<!-- AUTO:COMMANDS -->
**157 registered commands.** Key groups:
