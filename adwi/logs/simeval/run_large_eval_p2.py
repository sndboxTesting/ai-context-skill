...
REGEX_INTENTS = [
    ...
    # FIX-RES-004: "look up X on the web/online" → web_search
    ...
    # FIX-NR-002: "kick off/start the nightly" + "start nightly tasks"
    ...
    # FIX-MR-001/003/004/005: "what did I write/think about X", "what were my notes on X"
