# Adwi NLU Eval Session — session-20260615-200525
*Generated: 2026-06-15 20:11:06*
...
| Avg LLM latency | 987 ms |
| P95 LLM latency | 1227 ms |
...
- Average LLM latency: **987 ms**
- P95 LLM latency: **1227 ms**

**Top 5 slowest prompts:**
  - 1741ms: `explain the difference between Qdrant and Chroma`
  - 1678ms: `i want to know more about how to set up a proper n8n webhook to trigger adwi com`
  - 1583ms: `explain the difference between ollama and openai api`
  - 1304ms: `how fast is llama3.1:8b`
  - 1297ms: `what's new in python 3.14`

### Routing Consistency Issues

15 paraphrase families showed inconsistent routing:

- **cleanup_basic**: saw ['organize', 'memory_recall', 'cleanup', 'disk_usage', 'large_files'] (25% majority)
- **fix_error_basic**: saw ['image', 'generate_image', 'old_files', 'disk_usage', 'chat', 'fix_error'] (25% majority)
- **large_files_basic**: saw ['large_files', 'disk_usage'] (50% majority)
- **git_status_basic**: saw ['git_status', 'chat', 'disk_usage', 'memory_recall'] (50% majority)
- **model_status**: saw ['generate_image', 'disk_usage', 'status'] (50% majority)
...
- **15 new NLU fixture candidates** generated from routing failures
  - Written to: `/Users/MAC/SuneelWorkSpace/logs/simeval/session-20260615-200525/new_eval_assets.jsonl`
  - Review and add to `adwi/memory.py` NLU_SEED_FIXTURES if correct

---

*Session artifacts in: `/Users/MAC/SuneelWorkSpace/logs/simeval/session-20260615-200525`*
